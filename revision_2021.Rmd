...
```{r echo = TRUE,eval=FALSE, include = TRUE,results='asis'}
library(dplyr)
library(tidyverse)
library(xtable)
...
```{r echo = TRUE, eval=FALSE,include = TRUE,fig.cap = "Porcentaje de abandono por departamento",fig.align="center", fig.width=5,fig.height=5}
prop_depto<-datos %>%
