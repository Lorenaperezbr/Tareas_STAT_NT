...
```
\textbf{\textcolor{violet}{No es reproducible, estás leyendo los datos con el directorio que funciona solo en tu compu. No estás usando correctamente la función here}}
...
prop
```
\textbf{\textcolor{violet}{Saqué el eval=FALSE para que salga la tabla (10 Puntos)}}
...
\textbf{\textcolor{violet}{El denominador en el cálculo del porcentaje es incorrecto, pusiste el total y no las observaciones de Montevideo. (5 Puntos)}}
...
```{r echo = TRUE,include = TRUE,fig.cap = "Porcentaje de abandono por departamento",fig.align="center", fig.width=5,fig.height=5}
prop_depto<-datos %>%
...
\fbox{\textbf{\textcolor{violet}{El eje x es Porcentaje de abandono, no proporción (9 Puntos)}}}
...
```{r echo = TRUE, include = TRUE,fig.cap = "Proporción de abandono por departamento y por sexo",fig.align="center", fig.width=5,fig.height=5}
...
```{r echo = TRUE, eval=FALSE,include = TRUE,fig.cap = "Proporción de abandono por departamento y por sexo",fig.align="center", fig.width=5,fig.height=5}
...
\fbox{\textbf{\textcolor{violet}{El eje x es Porcentaje de abandono,no proporción (3 Puntos)}}}
...
\fbox{\textbf{\textcolor{violet}{Te quedó la condición alrevez  (9 Puntos)}}}
...
\fbox{\textbf{\textcolor{violet}{Te faltó el argumento cols  (3 Puntos)}}}
...
\fbox{\textbf{\textcolor{violet}{Incompleto, ver sol (3 Puntos)}}}
...
\textbf{\textcolor{violet}{Tu prueba no fue reproducible porque pusiste un directorio absoluto, tu repositorio estaba ordenado hasta la prueba, algunas partes de tu código se puede restructurar para que sea más sencilla su lectura (11 Puntos). TOTAL DE PUNTOS 76/130}}
